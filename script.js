...
(function () {
  ...
  const ContactForm = (() => {
    ...
    // Delivers to sumitkumar40596@gmail.com via FormSubmit — no backend required.
    ...
    const ENDPOINT = 'https://formsubmit.co/ajax/sumitkumar40596@gmail.com';
    ...
    form.addEventListener('submit', async (e) => {
      ...
      try {
        ...
        note.textContent = "Something went wrong sending that. Please email sumitkumar40596@gmail.com directly.";
        note.classList.remove('success');
      } finally {
